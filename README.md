...
SwiftUI ve Firebase ile geliştirilmiş harcama takip uygulaması. Açık/koyu tema geçişleri gibi bazı konularda hatalar şu an için mevcut. Boş vaktimde eksikleri ve hataları düzelteceğim.
...
- 💸 **Harcama Takibi** - Günlük, haftalık ve aylık harcamalarınızı izleyin
- 📊 **Analitik Dashboard** - Pie chart ile kategori bazlı harcama dağılımı
- 💳 **Bütçe Yönetimi** - Aylık bütçe belirleme ve otomatik uyarı sistemi
  - Bütçe İlerleme Göstergesi
  - Gerçek Zamanlı Uyarılar
  - Bütçe Durumu Göstergesi (Yeşil/Sarı/Kırmızı)
...
### #HandCoded #SwiftUI #Firebase #iOS
